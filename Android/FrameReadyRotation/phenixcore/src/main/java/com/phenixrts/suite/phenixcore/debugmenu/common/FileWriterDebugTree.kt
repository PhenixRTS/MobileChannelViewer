...
import com.phenixrts.suite.phenixcore.common.PHENIX_CORE_TIMBER_TAG
...
class FileWriterDebugTree(private val context: Application) : Timber.DebugTree() {
    ...
    override fun log(priority: Int, message: String?, vararg args: Any?) {
        ...
        launchIO {
            getFormattedLogMessage(PHENIX_CORE_TIMBER_TAG, priority, message, null).run {
                writeAppLogs(this)
            }
        }
    }
    ...
    override fun log(priority: Int, t: Throwable?, message: String?, vararg args: Any?) {
        ...
        launchIO {
            getFormattedLogMessage(PHENIX_CORE_TIMBER_TAG, priority, message, t).run {
                writeAppLogs(this)
            }
        }
    }
